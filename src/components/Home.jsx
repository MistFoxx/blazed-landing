...
export default function Home() {
  return (
    ...
    <div className="flex flex-wrap-reverse items-center p-4">
      ...
      <div className="flex justify-center items-center m-auto w-full lg:w-3/5 max-h-screen">
        <Image
        ...
        width={380}
        height={400}
        className="rounded-tl-full rounded-tr-full mb-5 h-96 w-80 lg:w-1/2 lg:h-1/2 object-cover"
        />
      </div>
    </div>
    </div>
